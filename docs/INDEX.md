...
| Feature-Artefakte | `docs/project/features/` | Pro Feature ein Unterordner mit versionierten Plänen (`plan-v001.md`, `plan-v002.md`), Plan-Reviews, Plan-Updates, später `user-guide.md` und `developer-notes.md` |
...
| `docs/project/features/[feature-name]/` | `plan-v001.md`, `plan-v002.md`, `plan-reviews/`, `plan-updates/`; später `user-guide.md`, `developer-notes.md` und ggf. Validierungsnotizen |
